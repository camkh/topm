...
CREATE TABLE `counter` (
  ...
  `cnt_hour` int(2) DEFAULT NULL,
  `cnt_minute` int(2) DEFAULT NULL,
  `cnt_date` datetime DEFAULT NULL,
  `cnt_day` int(2) DEFAULT NULL,
  `cnt_month` int(2) DEFAULT NULL,
  `cnt_year` int(4) DEFAULT NULL,
...
CREATE TABLE `district` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dis_name_en` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `dis_name_km` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `product` (
  ...
  `title_km` varchar(250) DEFAULT NULL,
...
insert  into `product_in_category`(`product_id`,`category_id`,`user_id`,`order`) values (36,87,101,NULL),(36,20,101,NULL),(36,73,101,NULL),(37,19,101,NULL),(38,20,101,NULL),(38,73,101,NULL),(38,87,101,NULL),(40,19,96,NULL),(40,103,96,NULL),(40,104,96,NULL),(40,109,96,NULL),(45,19,96,NULL),(45,20,96,NULL),(45,73,96,NULL),(46,19,102,NULL),(46,20,102,NULL),(46,55,102,NULL),(48,20,103,NULL),(48,73,103,NULL),(48,80,103,NULL),(49,19,102,NULL),(49,20,102,NULL),(49,98,102,NULL);
...
insert  into `s_category`(`id`,`name_en`,`name_km`,`m_cat_id`,`m_title`,`user_id`,`parent_id`,`order`,`is_publish`) values (340,'Computer Software Network Hardware','Computer Software Network Hardware',20,NULL,103,0,0,1),(341,'Computer-Accessory','Computer-Accessory',73,NULL,103,20,1,1),(342,'Blank Media','Blank Media',80,NULL,103,73,2,1),(343,'Card Reader','Card Reader',87,NULL,103,73,3,1),(344,'Computer-Speaker','Computer-Speaker',94,NULL,103,73,4,1),(345,'Electronic Consumer','Electronic Consumer',103,NULL,103,0,5,1),(346,'Phone','Phone',104,NULL,103,103,6,1),(347,'Ecom','Ecom',109,NULL,103,104,7,1);
...
insert  into `user`(`id`,`name`,`email`,`password`,`password_temp`,`status`,`create_at`,`update_at`,`remember_token`,`user_type`,`account_type`,`account_role`,`client_type`,`telephone`,`address`,`user_name`,`province_id`) values (2,'KOCH Doeun','doeunkoch@gmail.com','$2y$10$9zwNoGkcOPhycNEP/P2xPuWkXJZmuXlT9rEV2Y.0TxQTsO9NbtlXq',NULL,1,'2014-12-04',NULL,'4PCRCJYWpnIbXyo2fNIDAdXiwkomMwW8eDRQbPqCXCE1tmB4ADFodnUdF8WH',1,NULL,NULL,NULL,'0972793573','Phnom Penh','admin',NULL),(102,'Ronan Thomas','free@gmail.com','8843028fefce50a6de50acdf064ded27',NULL,1,'2015-09-17',NULL,NULL,4,1,1,5,'+711-94-8124283','{\"province\":\"24\",\"disctict\":\"2\",\"g_latitude_longitude\":\"13.666667, 103\"}','',NULL),(103,'Phoebe Sanford','inter@gmail.com','8843028fefce50a6de50acdf064ded27',NULL,1,'2015-09-17',NULL,NULL,4,2,5,2,'+919-88-2651140','{\"province\":\"15\",\"disctict\":\"19\",\"g_latitude_longitude\":\"13.263695, 102.880623\"}','',NULL),(104,'Amaya Newman','free1@gmail.com','8843028fefce50a6de50acdf064ded27',NULL,1,'2015-09-27',NULL,NULL,4,1,5,1,'+638-84-8614752','{\"province\":\"7\",\"disctict\":\"84\",\"g_latitude_longitude\":\"12.166667, 106.583333\"}','',NULL),(105,'Rhona Newman','free2@gmail.com','8843028fefce50a6de50acdf064ded27',NULL,1,'2015-09-27',NULL,NULL,4,1,3,1,'+359-88-8289088','{\"province\":\"9\",\"disctict\":\"57\",\"g_latitude_longitude\":\"10.6, 104.166667\"}','',NULL),(108,'Jerome Hart','free3@gmail.com','8843028fefce50a6de50acdf064ded27',NULL,1,'2015-09-27',NULL,NULL,4,1,5,2,'+289-10-6730632','{\"province\":\"16\",\"disctict\":\"31\",\"g_latitude_longitude\":\"12.314167, 105.2775\"}','',NULL);
