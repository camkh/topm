<header class="header navbar navbar-fixed-top" role="banner">
	<div class="container">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown"><a href="#" class="dropdown-toggle"
				data-toggle="dropdown">Product Management <i
					class="icon-caret-down small"></i></a>
				<ul class="dropdown-menu">
					<li><a href="{{URL::to('admin/products/free')}}">Free Product</a></li>
					<li><a href="{{URL::to('admin/products/premium')}}">Enterprise
							Product</a></li>
			...
			<li class="dropdown"><a href="#" class="dropdown-toggle"
				data-toggle="dropdown">Business Management <i
					class="icon-caret-down small"></i></a>
				<ul class="dropdown-menu">
					<li><a href="#">Product Advertisement</a></li>
					<li><a href="{{URL::to('admin/advertisements')}}">Banner
							Advertisement</a></li>
